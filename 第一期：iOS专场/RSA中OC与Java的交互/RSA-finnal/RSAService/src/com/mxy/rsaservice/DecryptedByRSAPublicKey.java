...
/**
 * Servlet implementation class DecryptedByRSAPublicKey
 */
@WebServlet("/DecryptedByRSAPublicKey")
public class DecryptedByRSAPublicKey extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try { 
			...
			decryptedString = rsaEncryptor.decryptedByPublicKey(data);
		} catch (Exception e) {
			e.printStackTrace();
