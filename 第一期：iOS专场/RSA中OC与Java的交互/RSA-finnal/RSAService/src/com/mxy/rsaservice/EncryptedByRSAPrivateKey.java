...
/**
 * Servlet implementation class EncryptedByRSAPrivateKey
 */
@WebServlet("/EncryptedByRSAPrivateKey")
public class EncryptedByRSAPrivateKey extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
			...
			encryptedData = rsaEncryptor.encryptedByPrivateKey(data);
		} catch (Exception e) {
			e.printStackTrace();
